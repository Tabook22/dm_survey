...
class Main_Sr2_Form(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets ={
            ...
            'cho1_1':forms.Select(attrs={'style':'min-width:100px'}),
             'cho1_2':forms.Select(attrs={'style':'min-width:100px'}),
            'cho1_3':forms.Select(attrs={'style':'min-width:100px'}),
            'cho1_4':forms.Select(attrs={'style':'min-width:100px'}),
